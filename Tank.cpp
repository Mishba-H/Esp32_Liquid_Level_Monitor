...
bool Tank::begin(const char* filename) {
    ...
    Serial.print("- Full Capacity: "); Serial.println(_fullTankCapacity);
    Serial.print("- Cross-Section Area: "); Serial.println(_tankCrossSectionArea);
    Serial.print("- Tank Depth: "); Serial.println(_tankDepth);
    Serial.print("- Sensor Offset: "); Serial.println(_sensorOffset);
